/**
  ...
  * @version V1.1.1
  * @date 8/12/2014
  * derni�re actualisation : 12 d�cembre 2016
...
/* Valeurs destin�es aux registres de configuration des ports */
...
#define PORT_C_DIRECTION 0x00  //  7 bits en entr�e
...
#define PORT_D_TECHNO_LIGNES 0x88  // ligne 7 en pull up pour BP1 est�rieur,
                                   // ligne 3 en Push Pull, ligne 0 en open drain

// Port E pourI2C, entr�es analogiques et 2 signaux /WR HDLX													 // bit 4 push pull
#define PORT_E_DIRECTION 0x28 // lignes 3 et 5 en sortie
#define PORT_E_TECHNO_LIGNES 0xA8  // ligne 7 pull up pour BP2 ext�rieur,
...
/* Masques destin�s aux 2 modules d'affichage HDLX */
...
/* autres d�finitions pour �l�ments de la carte d'accueil */

#define ALLUMEE 0 // pour led verte
#define ETEINTE 1

#define ACTIF 0  // pour les 2 BP ext�rieurs
#define NON_ACTIF 1
